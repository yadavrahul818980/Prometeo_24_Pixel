...
class _myCartState extends State<myCart> {
  ...
  Future<void> fetchDataFromAPI() async {
    String apiUrl =
        'https://trendify-ui65.onrender.com/getCart'; // Replace with your API endpoint
    ...
    try {
      var response = await http.get(
        ...
        headers: <String, String>{
          ...
          'Authorization':
              'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOiI2NWFiNzIwYjE2MWUxMjNhZjllYjcxYWUiLCJpYXQiOjE3MDU3MzQ2NjcsImV4cCI6MTcwNjU5ODY2N30.wnBp20o3JkHJ6q2Ogc3Ffz_-UQl5cLKzUeGugS3bl80'
        },
      );
            ...
            GestureDetector(
              onTap: () {
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          (HomePage()), // Replace with your next page widget
                    ));
              },
              child: Image.asset(
                'assets/backButton.png',
